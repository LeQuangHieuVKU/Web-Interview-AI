  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`w-full ${isModel ? "max-w-md p-8 rounded-3xl" : "max-w-ld p-12 rounded-[24px]"} bg-white shadow-2xl border border-gray-200`}
      >
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className="bg-black text-white p-2 rounded-1g">
            <BsRobot size={18} />
          </div>
        ...
        <p className="text-gray-500 text-center text-sm md:text-base leading-relaxed mb-8">
          ...
          unlock details performance insights
        </p>
        <motion.button
